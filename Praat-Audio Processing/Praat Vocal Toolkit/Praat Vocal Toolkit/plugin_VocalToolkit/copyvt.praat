# Vocal tract length estimation was adapted from the procedure described at: https://web.archive.org/web/20190616135811/http://www.languagebits.com/phonetics-english/resonant-frequencies-and-vocal-tract-length/
...
include preview.inc
			...
			if show_info
				...
				appendInfoLine: "> https://bit.ly/vocal-tract-length-estimation", newline$, newline$, newline$
			endif
		else
			selectObject: s1, s2
